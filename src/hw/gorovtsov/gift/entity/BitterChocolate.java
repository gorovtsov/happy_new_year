...
public class BitterChocolate extends SweetStuff{
	...
	public BitterChocolate() {
		...
		this.name = "Коммунарка";
	}
	
	public BitterChocolate(int weight, int containsSugar, String name) {
		this.weight = weight;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BitterChocolate other = (BitterChocolate) obj;
	...
	public String toString() {
		return name + "[ Горькая шоколадка | вес =" + weight + ", Сахара на 100г=" + containsSugar + "]";
	}
}
